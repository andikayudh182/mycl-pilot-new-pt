    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{url('/operator/mylea/monitoring/konta-update')}}" class="m-5">
                @csrf
                <input type="hidden"  name="id" value="{{$data['id']}}">
                <div class="row mb-3 ">
                    <label for="KodeProduksi" class="col-sm-2 col-form-label col-form-label-sm">Kode Produksi :</label>
                    <div class="col-sm-5">
                        <input type="text" name="KPMylea" value="<?php echo $data['KPMylea'];?>" class="Disabled input example form-control-sm">
                    </div>
                </div>
                <div class="row mb-3 ">
                    <label for="KodeProduksi" class="col-sm-2 col-form-label col-form-label-sm">Kode Produksi Baglog :</label>
                    <div class="col-sm-5">
                        <input type="text" name="KodeProduksi" value="<?php echo $data['KPBaglog'];?>" class="Disabled input example form-control-sm">
                    </div>
                </div>
                <div class="row mb-3 ">
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col-sm-5">
                        <input type="number" name="JumlahKonta" class="form-control form-control-sm  @error('JumlahKonta') is-invalid @enderror" id="colFormLabelSm" value="{{ $data['Jumlah'] }}">
                        @error('JumlahKonta')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mb-3 ">
                    ...
                    <div class="col-sm-5">
                        <input type="date" name="TanggalKonta" class="form-control form-control-sm  @error('TanggalKonta') is-invalid @enderror" id="colFormLabelSm" value="{{ $data['TanggalKontaminasi'] }}">
                        @error('TanggalKonta')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mb-3 ">
                    <label for="KondisiBaglog" class="col-sm-2 col-form-label col-form-label-sm">Kondisi Baglog:</label>
                    <div class="col-sm-5">
