...
<script src="https://cdn.datatables.net/1.10.24/js/jquery.dataTables.min.js"></script>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('temperature-humidity-baglog.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="TemperatureHumidity" class="form-label">Upload File Temperature Humidity Baglog Room (Excel)</label>
        ...
        {{-- Collapse Filter --}}
            @include('admin.Environtment.TemperatureHumidity.FilterDateBaglogRoom')
        {{-- End Collapse Filter --}}
        ...
        {{-- Baglog Room Chart --}}
            @include('admin.Environtment.TemperatureHumidity.ChartPartials.BaglogRoomChart')
        {{-- End Baglog Room Chart --}}
